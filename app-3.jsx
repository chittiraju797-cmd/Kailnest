          ...
          <div style={{ padding: "12px 20px 24px", borderTop: "1px solid #f3f4f6" }}>
            ...
            {step < 3 ? (
              <button onClick={() => setStep(step + 1)} disabled={
                ...
                (step === 2 && (!form.price || !form.phone || form.phone.length !== 10))
              } style={{
                flex: 2, padding: "12px",
                background: ((step === 1 && (!form.name || !form.location || !form.city)) || (step === 2 && (!form.price || !form.phone || form.phone.length !== 10))) ? "#d1d5db" : "linear-gradient(135deg, #6366f1, #8b5cf6)",
