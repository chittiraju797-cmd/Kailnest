      ...
      <div style={{ background: "#fff", borderRadius: "22px 22px 0 0", width: "100%", padding: 20, maxHeight: "85vh", overflowY: "auto" }}>
        ...
        {paid ? (
          <div style={{ textAlign: "center", padding: "30px 0" }}>
            ...
            <div style={{ color: "#6b7280", fontSize: 14, marginTop: 6 }}>Your listing will be activated</div>
          </div>
        ) : (
          <>
            {/* Header */}
            ...
            }}>✅ I have Paid ₹199 — Confirm</button>
